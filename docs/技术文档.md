...
Claude 对话浏览器是一个本地 Web 应用，支持 **Claude.ai 官方 JSON** 和 **Claude Code JSONL** 两种数据源。核心价值在于将机器可读的深层嵌套 JSON（15 种内容块类型、93 个对话、2338 条消息、11.95 MB）转换为接近 Claude 网页版体验的可读格式。
